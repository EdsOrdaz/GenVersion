...
{
    public partial class ASiTTi : Form
    {
        public ASiTTi()
        {
            InitializeComponent();
        ...
        private void ASiTTi_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conexion2.Open();
                    String sql2 = "SELECT valor as version,(SELECT valor FROM Configuracion WHERE nombre='ASitti_hash') as hash FROM Configuracion WHERE nombre='ASitti_Version'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conexion2.Open();
                    String sql2 = " UPDATE [Configuracion] SET [valor]='" + textBox1.Text + "' WHERE nombre='ASitti_Version'";
                    SqlCommand comm2 = new SqlCommand(sql2, conexion2);
                    SqlDataReader nwReader2 = comm2.ExecuteReader();

                    String sql2_1 = " UPDATE [Configuracion] SET [valor]='" + textBox2.Text + "' WHERE nombre='ASitti_hash'";
