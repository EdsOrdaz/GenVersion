...
{
    public partial class VerEconomico : Form
    {
        public VerEconomico()
        {
            InitializeComponent();
        ...
        private void VerEconomico_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conexion2.Open();
                    String sql2 = "SELECT valor as version,(SELECT valor FROM Configuracion WHERE nombre='VerEconomico_hash') as hash FROM Configuracion WHERE nombre='VerEconomico_Version'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conexion2.Open();
                    String sql2 = " UPDATE [Configuracion] SET [valor]='" + textBox1.Text + "' WHERE nombre='VerEconomico_Version'";
                    SqlCommand comm2 = new SqlCommand(sql2, conexion2);
                    SqlDataReader nwReader2 = comm2.ExecuteReader();

                    String sql2_1 = " UPDATE [Configuracion] SET [valor]='" + textBox2.Text + "' WHERE nombre='VerEconomico_hash'";
                    SqlCommand comm2_1 = new SqlCommand(sql2_1, conexion2);
                    SqlDataReader nwReader2_1 = comm2_1.ExecuteReader();
                    MessageBox.Show("Version actualizada.\nPrograma: VerEconomico\n", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    Close();
                }
            }
            catch (Exception ex)
