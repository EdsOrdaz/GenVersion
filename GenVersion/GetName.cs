    ...
    public partial class GetName : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conexion2.Open();
                    String sql2 = " UPDATE [Configuracion] SET [valor]='" + textBox1.Text + "' WHERE nombre='GetName_Version'";
                    SqlCommand comm2 = new SqlCommand(sql2, conexion2);
                    SqlDataReader nwReader2 = comm2.ExecuteReader();

                    String sql2_1 = " UPDATE [Configuracion] SET [valor]='" + textBox2.Text + "' WHERE nombre='GetName_hash'";
        ...
        private void GetName_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conexion2.Open();
                    String sql2 = "SELECT valor as version,(SELECT valor FROM Configuracion WHERE nombre='GetName_hash') as hash FROM Configuracion WHERE nombre='GetName_Version'";
                    SqlCommand comm2 = new SqlCommand(sql2, conexion2);
                    SqlDataReader nwReader2 = comm2.ExecuteReader();
